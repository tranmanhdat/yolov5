...
class Yolov5:
    ...
    def inference(self, img, save_path,
        ...
        # Dataloader
        dataset = LoadImage(img, img_size=self.imgsz, stride=self.model.stride, auto=self.model.pt)
        bs = 1  # batch_size
            ...
            for i, det in enumerate(pred):  # per image
                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if save_path:  # Add bbox to image
...
if __name__ == "__main__":
    model = Yolov5()
    text = model.inference('/home/trandat/project/p51/object_detection/backend/data_test/src/1.jpg', '/home/trandat/project/p51/object_detection/backend/data_test/result/1.jpg', '/home/trandat/project/p51/object_detection/backend/data_test/result/1.txt')